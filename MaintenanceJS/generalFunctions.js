...
function getCoverImage(imgid,angleid)
{
    ...
    else 
    {
        ...
        if(imgangle == 0 || imgangle == 180)
        {
            ...
            if(imgheight >= 1000)
            {
                console.log("1.1 height is greater than 1000, will separate the page, need to set the height")
                imageSection = {
                    image: imgSrc,
                    height: 260,
                    width: 210,
            ...
            {
                console.log("1.2 height is smaller than 1000,don't need to set the height, only set the width")
                imageSection = {
                    image: imgSrc,
                    width: 190,
                }
        ...
        else
        {
            ...
            if(imgwidth >=1000)
            {
                console.log("2.1 width is greater than 1000, will separate the page, need to set the height")
                imageSection = {
                    image: imgSrc,
                    height: 260,
                    width: 210,
            ...
            {
                console.log("2.2 width is smaller than 1000,don't need to set the height, only set the width");
                imageSection = {
                    image: imgSrc,
                    width: 180
                }

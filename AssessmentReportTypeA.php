...
?>
    ...
    <body>
        ...
        <!--Site and Garden-->
        <div class="container">
            <h2 class="content-head text-center firstH1">Site</h2>
            <br>
        </div>
  ...
  <br><br><br><br>
    ...
    ?>
        ...
        <script src="AssessmentTypeAJS/htmlGeneralFunctions.js?<?php echo time(); ?>"></script>
        <script src="AssessmentTypeAJS/pdfGeneralFunctions.js?<?php echo time(); ?>"></script>
        <script src="AssessmentTypeAJS/text.js?<?php echo time(); ?>"></script>
        <script src="AssessmentTypeAJS/PDFGenerator.js?<?php echo time(); ?>"></script>
        <script src="AssessmentTypeAJS/getTableData.js?<?php echo time(); ?>"></script>
    </body>

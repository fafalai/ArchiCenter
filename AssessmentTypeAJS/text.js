...
/*
 Store Assessment Property Report Texts variables
 */
...
var coverPageText = 'This Property Assessment Report is a visual assessment of the conditions of the reasonably accessible areas of the property at the time of the assessment.';
...
var whatNotIncU8 = 'Condition, compliance or assessment of Essential Safety Measures including fire, life safety and health items installed or constructed in a building to ensure adequate levels of fire safety and protection.';
...
var defectDefinitionP4 = 'In the case of cracking, a serious structural defect denotes severe cracking as defined by Category 4, Appendix C – Australian Standard AS 2870-2011.';

var AssessmentAccess1 = 'The architect can only assess the reasonably accessible parts of the property. It is your responsibility to ensure that any inaccessible parts of the property that can be made reasonably accessible for an assessment are made so, prior to the assessment. If parts of the property have been noted as being inaccessible during the assessment, it is important that you contact the architect and arrange for a second assessment when access to restricted areas has been made available. Inaccessible areas cannot be assessed.';

var AssessmentAccess2 = 'Reasonably and Safely Accessible – Accessible areas which can be accessed by a 3.6 metre ladder or those which have at least 600mm unimpeded vertical and horizontal clearance without the removal of any fixed or unfixed furniture, fittings, stored items, cladding or lining materials, plants or soil.';

var AssessmentAccess3 = 'Archicentre Australia architects are unable to access areas where there is a risk of adverse disturbance or damage to the property, including the garden area. The architect will determine the extent of accessible areas at the time of the assessment.';

var AssessmentAccess4 = 'Workplace Health and Safety access conditions apply subject to relevant State and Territory regulations. Archicentre Australia authorised architects are unable to inspect areas higher than 3 metres above ground level unless secure ladder access is available and fall prevention devices or barriers are present. High level access equipment may provide access where this has been explicitly requested and agreed in writing prior to the assessment.';

var AssessmentAccess5 = 'Reasonable Access may not be possible due to physical obstructions or conditions that may be hazardous or unsafe to the architect.';

var AssessmentAccess6 = 'Access restrictions will be noted where appropriate.';

var yourProAssSumText = 'This Property Assessment summary provides you with a “snapshot” of the items the architect considers of greatest significance for you when considering this property. Please refer to the Definitions and the complete Report for detailed information regarding visible defects and recommended actions. Please note that this summary is not the complete Report and that in the event of an apparent discrepancy the complete Report overrides the Summary information.';

var attachmentText1 = 'The following selected attachments are an important part of this Report. These can be downloaded from the Archicentre Australia Supplementary Documents page ';
...
var generalAdviceList4 = 'The condition of timber-framed or concrete decks and balconies deteriorates over time – annual assessments should be undertaken to verify their safety.';
...
var generalAdviceList6 = 'This assessment does not include an assessment of essential safety measures and prospective purchasers/ leasers should make their own enquiries in this regard.';

var generalAdviceList7 = 'If you are purchasing the property, Archicentre Australia recommends a review of all door and window locks and security systems, appliance and equipment at settlement.';
...
var termsAndConditionsOL6 = 'Archicentre Australia’s liability shall be limited to the provision of a new assessment and report or the payment of the cost of a new assessment and report, at the election of Archicentre Australia.';
...
var termsAndConditionsOL8 = 'The Property Maintenance Guide constitutes a vital part of the architect’s recommendations and failure to observe either the recommendations or the Property Maintenance Guide could lead to premature deterioration of the property.';

var termsAndConditionsOL9 = 'The Health and Safety Warnings constitutes a vital part of Archicentre Australia’s recommendation to you. Failure to observe the provisions of the warning sheet could jeopardise the safety of the occupants.';

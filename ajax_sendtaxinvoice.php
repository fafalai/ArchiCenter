                ...
                if ($numrows = SharedNumRows($dbresult))
                {
                    ...
                    while ($dbrow = SharedFetchArray($dbresult))
                        ...
                        if ($booking['custemail'] != "")
                        {
                            ...
                            if( $booking['reportheader'] != "")
                            {
                                error_log("1.1 has subheader,update invoice html");
                                if($booking['reportid'] == 25)
                                {
                                ...
                                if($dbresult1 && $dbresult2)
                                {
                                    ...
                                    if($booking['reportheader'] != "")
                                    {
                                      ...
                                      else
                                      {
                                        ...
                                        $subject = $booking['bookingcode'] . " - " . $reportTypes[$booking['reportid']] ." - " . $booking['reportheader']. " Booking Tax Invoice";
                                      }
                                    ...
                                    else
                                    {
                                      ...
                                      if($booking['reportid'] == 25)
                                      {
                                        $subject = $booking['bookingcode'] . " - Property Assessment -  Architect/Inspector Report Booking Tax Invoice";
                                      }
                                      else
                                      {
                                        error_log("3.2 not type A report");               
                                        $subject = $booking['bookingcode'] . " - " . $reportTypes[$booking['reportid']] . " Booking Tax Invoice";
                                      }
                            ...
                            else
                            {
                                ...
                                if ($dbresult1 && $dbresult2 && $dbresult3 && $dbresult4)
                                {
                                    ...
                                    $custemail = explode(",",$booking['custemail']);
                                    $subject = $emailcode . " - " . $reportTypes[$booking['reportid']] . " Booking Tax Invoice";
                                    SharedSendHtmlMail($gConfig['adminemail'], "Archicentre Australia", $custemail, $booking['custfirstname'] . ' ' . $booking['custlastname'], $subject, $html,"","",$attachmentPath);
                                    $rc = 0;
                                    $msg = "Send the tax invoice to client successfully";
                                }

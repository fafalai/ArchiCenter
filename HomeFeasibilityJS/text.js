...
var archHomeFeasibilityReportText1 = 'An Archicentre Australia New Home Design Report (‘Report’) is a feasibility study which will explore your property’s potential and provide information to help you to decide whether to proceed with your project and whether to engage your Archicentre Australia Architect for ongoing services.\n\n';

var archHomeFeasibilityReportText2 = 'The presented New Home Design Sketches (‘Design’) is a response to your project requirements and objectives, and considers your existing site, your budget, sustainability and possible regulatory issues.\n\n';

var archHomeFeasibilityReportText3 = 'This Report is not intended to provide the final design solution for your new home but rather present you with a visual representation of an initial feasibility study. This is intended to help you to re-assess, confirm or clarify your needs.\n\n';

var archHomeFeasibilityNotes1 = 'Further detailed work outside the scope of this Report, will be necessary to develop the Design. The Design will evolve as your needs are explored, assessed and fine-tuned to the point where it will be ready to begin construction documentation.';
...
var archHomeApprovals2 = 'This may include obtaining a feature survey of your property, geotechnical (soil) investigations, confirmation of service easements and/or connection points.';

var archHomeApprovals3 = 'You should seek advice from a professional consultant that provides these services - your Architect can assist you in their engagement.';

var archHomeApprovals4 = 'The construction of the proposal presented in this Report will require the following approvals:';

var archHomeCost1 = 'Construction costs vary considerably depending on the type of construction, duration of the project, ease of site access, type of fixtures and fittings and market conditions.  Completing the work in stages can make the costs more manageable, however this may also increase the total cost of the project.';

var archHomeCost2 = 'Project quality and cost control can best be achieved by obtaining competitive tenders/quotations from a number of reputable builders, based on detailed documents prepared by an Archicentre Australia Architect.  Assistance in cost control may also be improved by engaging a quantity surveyor.';

var archHomeCost3 = 'The figures provided below are in the range of typical costs expected for a project of your type. (Please note that they are not quotations or estimates but merely broad opinions of the construction costs).  A more accurate opinion of the probable cost will need to be prepared once more detailed drawings have been finalised.  However, the tender process – obtaining quotations from suitable builders, leading to negotiation and the eventual signing of a building contract - is the only way of achieving certainty on price.';

var archHomeCost4 = 'The information below is based on the preliminary information you have provided about your site, and where possible a preliminary visual assessment.  A detailed analysis of the site features and conditions may affect the likely construction costs. If you decide to continue with your project and engage your Archicentre Australia Architect, this would be one of the next steps undertaken.';

var archHomeCost5 = 'This broad opinion of cost is based on the Design presented in this Report.  If the Design changes, the broad opinion of cost may be different.';

var archInvolved1 = 'Other consultants are referred to in this Report and may be needed for your project.  Your Archicentre Australia Architect can advise on which consultants may be required for your particular project. Here is a snapshot of the services some of the usually required consultants provide.  Please note that this is a summary only, not a complete list of the tasks they would or could perform as their services will be provided according to the terms of their engagement.';
var archInvolved2 = 'It is worth keeping in mind that managing the work of all of these consultants is a significant and skilled task and vital to the success of your project.  Your Archicentre Australia Architect can ensure that this task is managed properly by preparing a scope of work for them, obtaining quotations and co-ordinating their work.';
...
var termConditionBulletList1 = 'After making the booking, the client is deemed to have accepted these Terms and Conditions and Scope upon the architect arriving on site and/or meeting with you.';
...
var termConditionBulletList3 = 'The Report is based on the condition of the property at the time of the visual assessment made according to the terms noted above.';
...
var termConditionBulletList13 = 'Reference to Archicentre Australia in this Report and any other documentation includes its agents and representatives authorized to act on its behalf.';

    ...
    else
    {
        ...
        for (var i = 0; i < totalContainers.length; i++) 
        {
            ...
            if (typeof imgSrc  != "undefined")
            {
                ...
                {
                    console.log("1 angle is 0 or 180");
                    if(imgheight >= 950)
                    {
                        console.log("1.1 drawing height is greater than 950, will separate the page, need to set the height")
                        imgSection = {
                            image: imgSrc,
                            height: 600,
                            width: 500,
                    ...
                    {
                        console.log("1.2 drawing height is smaller than 950,don't need to set the height, only set the width")
                        imgSection = {
                            image: imgSrc,
                            width: 500,
                            //fit:[500,500],

...
<head>
    <meta charset="UTF-8">
    <title>Post Dilapidation Survey - <?php echo $bookingcode; ?></title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<div id="clientDetails" class="container">
    ...
    <form>
        <div class="row">
            <div class="col-sm-6">
                <label>Name</label><br>
                <input id="PDCustomerName" class="form-control" type="text" title="name" value="<?php echo doNiceArrayElemAsString('custfirstname') . " " . doNiceArrayElemAsString('custlastname'); ?>">
            </div>
            <div class="col-sm-6">
                <label>Booking No.</label><br>
                <input id="PDBookingNo" class="form-control" type="text" title="bookingNo" value="<?php echo $bookingcode; ?>">
            </div>
            <div class="col-sm-6" style="margin-top:6px">
                <label>Phone</label><br>
                <input id="PDCustomerPhone" class="form-control" type="text" title="phone" value="<?php echo doNiceArrayElemAsString('custphone'); ?>">
            </div>
            <div class="col-sm-6" style="margin-top:6px">
                <label>Mobile</label>
                <br>
                <input id="PDBookingMobile" class="form-control" type="text" title="phone" value="<?php echo doNiceArrayElemAsString('custmobile'); ?>">
            </div>
        </div>
    </form>
    <br>
    ...
    <form>
        <div class="row">
            <div class="col-sm">
                ...
                <input id="PDAssessmentAddress" class="form-control" type="text" title="address" value="<?php echo doNiceArrayElemAsString('address1'). " " .doNiceArrayElemAsString('address2'); ?>">
            </div>
        </div>
        <div class="row" style="margin-top: 3px">
            <div class="col-sm">
                <label>Suburb</label><br>
                <input id="PDAssessmentSuburb" class="form-control" type="text" title="suburb" value="<?php echo doNiceArrayElemAsString('city'); ?>">
            </div>
            <div class="col-sm">
                    <label>State</label><br>
                    <input id="PDAssessmentState" class="form-control" type="text" title="state" value="<?php echo doNiceArrayElemAsString('state', false); ?>">
            ...
            <div class="col-sm">
                ...
                <input id="PDAssessmentPostcode" class="form-control" type="text" title="postcode" value="<?php echo doNiceArrayElemAsString('postcode'); ?>">
            </div>
        </div>
    </form>
    <form>
        <div class="row form-group">
            <div class="col-sm">
                ...
                <textarea id="PDAssessmentDate" class="form-control" title="dateOfAssessment"></textarea>
            </div>
            <div class="col-sm">
                <label>Time of Assessment</label><br>
                <textarea id="PDAssessmentTime" class="form-control" title="time of assessment"></textarea>
            </div>
        </div>
        <div class="row form-group">
            <div class="col-sm">
                <label>Existing Use of Property</label><br>
                <textarea id="PDPropertyUse" class="form-control" title="existing use"></textarea>
            </div>
            <div class="col-sm">
                <label>Weather Conditions</label><br>
                <textarea id="PDAssessmentWeather" class="form-control" title="weather conditions"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-sm">
                <label>Verbal Summary to</label><br>
                <textarea id="PDVerbalSummary" class="form-control" title="verbal summary"></textarea>
            </div>
            <div class="col-sm">
                <label>Date</label><br>
                <textarea id="PDAssessmentDate2" class="form-control" title="date"></textarea>
            </div>
        </div>
    </form>
    <br>
    ...
    <form>
        <div class="row form-group">
            <div class="col-sm">
                ...
                <input id="PDArchitectName" class="form-control" type="text" title="architectName" value="<?php echo doNiceArrayElemAsString('archfirstname') . " " . doNiceArrayElemAsString('archlastname'); ?>">
            </div>
            <div class="col-sm">
                <label>Registration No.</label><br>
                <input id="PDRegistrationNumber" class="form-control" type="text" title="registrationNo" value="<?php echo doNiceArrayElemAsString('archregno'); ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-sm">
                <label>Architect Address</label><br>
                <input id="PDArchitectAddress" title="address" class="form-control" type="text" value="<?php echo doNiceAddress(doNiceArrayElemAsString('archaddress1'), doNiceArrayElemAsString('archaddress2'),doNiceArrayElemAsString('archcity'), doNiceArrayElemAsString('archstate'), doNiceArrayElemAsString('archpostcode')); ?>" >
        ...
        <div class="row form-group">
            <div class="col-sm">
                ...
                <input id="PDArchitectEmail"  class="form-control" type="text" title="architectEmail" value="<?php echo doNiceArrayElemAsString('archemail', false); ?>">
            </div>
            <div class="col-sm">
                <label>Phone</label><br>
                <input id="PDArchitectPhone" class="form-control" type="text" title="phone" value="<?php echo doNiceArrayElemAsString('archmobile', false); ?>">
            </div>
        </div>
    </form>
    <br>
...
<!--Summary-->
<div id="PostDilapidationReport" class="container">
    <h3 class="sectionSubHead">DILAPIDATION SURVEY REPORT SUMMARY</h3>
    <textarea id="PDSurveyReportSummary" class="form-control" rows="10" style="height: inherit" title="extraItemsCosts">Condition of Building:
    </textarea>
    <br>
</div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <input type="button" value="Upload Cover Image" class="uploadCoverImageButton"
                   onclick="PostDilapidationCover()">
            <input type="file" id="PostDilapidationUploadCoverImage" class="inputImage" accept="image/x-png,image/jpeg">
        </div>
...
<div class="container">
    ...
    Address:<input type="text" name="address" class="form-control" title="address" value="<?php echo doNiceArrayElemAsString('address1'); ?> <?php echo doNiceArrayElemAsString('city'); ?>" id="postDilapidationFullAddress">
    <br>
</div>
<div class="container">
    <div class="container">
    ...
    <br>
    <div class="container">
        <table id="PostDilapidationImagesTable" style="display: none">
            <tr>
                <th>
                    <div class="row form-group" id="PostDilapidationPhotographs">
                    </div>
...
<!--PDF Generator-->
<script src="DilapidationPostJS/PDFGenerator.js?<?php echo time(); ?>"></script>
<!--General Functions-->
<script src="DilapidationPostJS/generalFunctions.js?<?php echo time(); ?>"></script>
<script src="DilapidationPostJS/htmlGeneralFunctions.js?<?php echo time(); ?>"></script>
<!--Text-->
<script src="DilapidationPostJS/text.js?<?php echo time(); ?>"></script>
<!--Table Data-->
<script src="DilapidationPostJS/tableData.js?<?php echo time(); ?>"></script>
